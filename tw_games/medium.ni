...
The scullery part 2 is some text that varies. The scullery part 2 is " You make out a formless box.[if c_1 is open and there is something in the c_1] The formless box contains [a list of things in the c_1].[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is "[if c_1 is open and the c_1 contains nothing] The formless box is empty! What a waste of a day![end if]".
The scullery part 4 is some text that varies. The scullery part 4 is " If you haven't noticed it already, there seems to be something there by the wall, it's a table. [if there is something on the s_0]On the table you make out [a list of things on the s_0].[end if]".
The scullery part 5 is some text that varies. The scullery part 5 is "[if there is nothing on the s_0]The table appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
The scullery part 6 is some text that varies. The scullery part 6 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The scullery part 7 is some text that varies. The scullery part 7 is " American limited edition gate leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The scullery part 8 is some text that varies. The scullery part 8 is " door leading south.".
...
The bedchamber part 1 is some text that varies. The bedchamber part 1 is " door leading north. There is an exit to the south. Don't worry, it is unblocked.".
...
The vault part 0 is some text that varies. The vault part 0 is "This is going to sound unbelievable, but you've just entered a vault. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The o_0 is in r_3.
The description of o_1 is "The pair of pants is brand new.".
...
The s_0 is in r_2.
The description of k_0 is "The American limited edition keycard is cold to the touch".
...
The description of k_1 is "The type 1 keycard is heavier than it looks.".
...
The description of k_2 is "The metal of the formless passkey is hammered.".
...
Test quest0_0 with "unlock formless box with formless passkey / open formless box / take type 1 keycard from formless box / unlock type 1 box with type 1 keycard / open type 1 box / take American limited edition keycard from type 1 box / unlock American limited edition gate with American limited edition keycard / open American limited edition gate / go east / take shirt"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First thing I need you to do is to make it so that the formless box is unlocked. Then, open the formless box. And then, take the type 1 keycard from the formless box. After you h".
The objective part 1 is some text that varies. The objective part 1 is "ave taken the type 1 keycard, check that the type 1 box is unlocked with the type 1 keycard. After that, assure that the type 1 box is ajar. Then, recover the American limited edition keycard from the".
The objective part 2 is some text that varies. The objective part 2 is " type 1 box within the scullery. And then, make sure that the American limited edition gate is unlocked with the American limited edition keycard. And then, ensure that the American limited edition ga".
The objective part 3 is some text that varies. The objective part 3 is "te inside the scullery is open. And then, head east. Following that, lift the shirt from the floor of the attic. That's it!".
